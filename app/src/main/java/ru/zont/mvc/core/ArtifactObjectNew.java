...
public class ArtifactObjectNew implements Parcelable {
    ...
    public ArtifactObjectNew(String title, ArrayList<Query> queries/*, ArrayList<File> customImages*/) {
        this.title = title;
    ...
    @Override
    public boolean equals(Object obj) {
        if (obj instanceof ArtifactObjectNew) return Objects.equals(((ArtifactObjectNew) obj).id, id);
    ...
    public boolean dataEquals(ArtifactObjectNew object) {
    ...
    public boolean dataEqualsExcId(ArtifactObjectNew object) {
    ...
    public static final Parcelable.Creator<ArtifactObjectNew> CREATOR = new Parcelable.Creator<ArtifactObjectNew>() {
        @Override
        public ArtifactObjectNew createFromParcel(Parcel source) {
            return new ArtifactObjectNew(source);
        }

        @Override
        public ArtifactObjectNew[] newArray(int size) {
            return new ArtifactObjectNew[size];
        }
    };

    private ArtifactObjectNew(Parcel parcel) {
